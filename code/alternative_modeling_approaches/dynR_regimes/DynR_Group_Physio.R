...
#TODO:
# Fit physio as DV (perhaps at 2Hz?)
# Use CAID as IVs
# Model coupling of physios as moderated by IVs

# Consider flipping around where CAID becomes DV and physio is IV
# May be necessary to fit only two time series at a time given the rather different dynamics. Hard to have a unified equation
# Need to get sampling right for lags to be meaningful.
