...
save('sanitycheck_logevidence.mat', 'logEvidence', 'ids', 'models', 'rawparameters');
...
save('sanitycheck_rawparams.mat', 'sfrawparams', 'sfrawparamsm1', 'sfrawparamsm2', 'sfrawparamsm3', 'sfrawparamsm4', 'ids');
