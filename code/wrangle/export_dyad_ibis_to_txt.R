library(R.matlab)
library(dplyr)
load("/Users/alisonmarie526/Box Sync/DEPENd/Couples Data/data/align_split_atdifferentfreqs.RData")

basedir <- "/Users/alisonmarie526/Box Sync/DEPENd/Couples Data/data/vanBse_dyad_txt"
